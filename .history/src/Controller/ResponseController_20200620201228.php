...
class ResponseController extends AbstractController
{
    ...
    /**
     * @Route("/user/questionResponces/{id}/Reply/{responceId}", name="allResponces")
     */
    public function allReplies(EntityManagerInterface $manager, $id,Request $request)
    {
