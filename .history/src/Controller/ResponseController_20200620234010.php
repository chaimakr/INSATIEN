...
class ResponseController extends AbstractController
{
    ...
    /**
     * @Route("/user/Reply/delete/{responseId}/{replyId}", name="deleteResponse")
     */
    public function deleteReply($responseId,$replyId)
    {
        $manager = $this->getDoctrine()->getManager();
        $response = $manager->getRepository('App:Response')->findOneById($responseId);
