...
class Response
{
     ...
     * @ORM\Id()
     * @ORM\GeneratedValue()
     * @ORM\Column(type="integer",cascade={"persist"})
     */
    private $id;

    /**
     * @ORM\Column(type="text",cascade={"persist"})
     */
    private $content;
    ...
    /**
     * @ORM\Column(type="datetime",cascade={"persist"})
     */
    private $date;
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Response::class, inversedBy="responses",cascade={"persist"},cascade={"persist"})
     * @ORM\JoinColumn(nullable=true)
     */
    private $main;
